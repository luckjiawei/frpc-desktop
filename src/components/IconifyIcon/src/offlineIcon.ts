...
import memoryAltRounded from "@iconify-icons/material-symbols/memory-alt-rounded";
import memoryRounded from "@iconify-icons/material-symbols/memory-rounded";
...
addIcon("error", Error);
addIcon("warningRounded", WarningRounded);
...
addIcon("memory", memory);
addIcon("memory-rounded", memoryRounded);
addIcon("memory-alt-rounded", memoryAltRounded);
